...
titleAddNew = WebUI.getText(findTestObject('null'))

assert titleAddNew == 'Add New Site User'
...
isErrorIcon = WebUI.waitForElementVisible(findTestObject('null'), 10)

isErrorText = WebUI.waitForElementVisible(findTestObject('null'), 10)

assert isErrorIcon && isErrorText
