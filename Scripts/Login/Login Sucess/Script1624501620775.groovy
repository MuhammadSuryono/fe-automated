...
seeProfilePicture = WebUI.waitForElementVisible(findTestObject('Page_/img_LiFT Revamp_img-circle profile_img'), 0)
...
// atau
// profile image found
'Login success when user doesnt see error message'
assert hasErrorMessage == false

//WebUI.verifyElementText(findTestObject(null), '')
//
//WebUI.acceptAlert()
'Login success when user see profile picture'
assert seeProfilePicture == true : 'User should see profile picture'
