...
WebUI.click(findTestObject('Site Manager/Page_/div_USR0004 - admin'))

WebUI.click(findTestObject('Object Repository/Site Manager/Page_/button_Filter'))

verifyShowInTable = WebUI.verifyElementText(findTestObject('Site Manager/Page_/td_No records on database'), 'No records on database')
