...
WebUI.click(findTestObject('Object Repository/Page_/a_Site Management'))

WebUI.click(findTestObject('Object Repository/Page_/button_1 FM'))

WebUI.click(findTestObject('Object Repository/Page_/button_Add Project FM'))

WebUI.click(findTestObject('Object Repository/Page_/svg_- Choose File Manager -_css-19bqh2r'))

WebUI.click(findTestObject('Object Repository/Page_/div_USR0097 - Tes Input'))

WebUI.click(findTestObject('User/FormUser_ButtonSave'))

WebUI.click(findTestObject('Object Repository/Page_/button_OK'))

WebUI.click(findTestObject('Object Repository/Page_/button_Refresh'))
