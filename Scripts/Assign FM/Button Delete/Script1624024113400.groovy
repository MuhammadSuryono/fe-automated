...
WebUI.sendKeys(findTestObject('Object Repository/Page_/input_Lift Revamp_password'), Keys.chord(Keys.ENTER))
...
WebUI.click(findTestObject('Object Repository/Page_/button_2 FM'))

WebUI.click(findTestObject('Object Repository/Page_/i_Last Update2021-06-07 204317_fa fa-fw fa-trash-o'))
