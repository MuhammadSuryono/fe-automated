...
WebUI.click(findTestObject('Object Repository/Page_/i_Last Update2021-06-18 162120_fa fa-fw fa-pencil'))

WebUI.click(findTestObject('Object Repository/Page_/div_Edit Assign SiteCloseStatusNon ActiveSave'))
