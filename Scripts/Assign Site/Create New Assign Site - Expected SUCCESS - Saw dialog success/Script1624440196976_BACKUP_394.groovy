...
if (numberData == 1) {
	...
	WebUI.click(findTestObject('Assign Site/TableProject_ButtonSiteSecondRow'))
}
...
<<<<<<< HEAD
WebUI.setText(findTestObject('Assign Site/FormAssignSite_InputTextSite'), chooseSite)
...
numberData++
>>>>>>> d6a7cf667af8b8aa9f2133d1946f45976666db87
