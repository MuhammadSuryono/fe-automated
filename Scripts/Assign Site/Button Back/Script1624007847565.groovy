...
WebUI.click(findTestObject('Object Repository/Page_/td_5 Site'))

WebUI.click(findTestObject('Object Repository/Page_/td_5 Site'))

WebUI.click(findTestObject('Object Repository/Page_/button_5 Site'))

WebUI.click(findTestObject('Object Repository/Page_/button_Back'))
...
WebUI.click(findTestObject('Object Repository/Page_/button_Last Update2021-06-18 150315_btn-def_e5b502'))

WebUI.click(findTestObject('Object Repository/Page_/svg_Non Active_css-19bqh2r'))

WebUI.click(findTestObject('Object Repository/Page_/div_Active'))
...
WebUI.click(findTestObject('Object Repository/Page_/div_Edit Assign SiteCloseStatusActiveSave'))
...
WebUI.click(findTestObject('Object Repository/Page_/div_Non Active'))
