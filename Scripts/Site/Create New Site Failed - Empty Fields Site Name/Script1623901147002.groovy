...
'get site name value\r\n'
siteName = WebUI.getText(findTestObject('Page_/input_Site Name_site_name'))

'fill status'
WebUI.click(findTestObject('Page_/div_- Choose Status -'))

WebUI.click(findTestObject('Page_/div_Active'))

if (siteName == '') {
    isStatusFilled = true
}

assert isSiteNameFilled == false

assert isStatusFilled
