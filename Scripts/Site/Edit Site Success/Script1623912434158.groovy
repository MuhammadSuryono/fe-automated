...
WebUI.setText(findTestObject('Object Repository/Site Page/Page_/input_Site Name_site_name'), textEdit)
...
isSuccessText = WebUI.waitForElementVisible(findTestObject('page_/h2_Site Created site'), 30)
