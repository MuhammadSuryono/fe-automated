...
WebUI.setText(findTestObject('Object Repository/Page_/input_Site Name_site_name'), siteName)

'Pilih dropdown Active'
WebUI.click(findTestObject('Object Repository/Page_/div_- Choose Status -'))

if (isActive) {
    WebUI.setText(findTestObject('Site/Form Site/FormSite_TextInputStatus'), 'Active')

    WebUI.sendKeys(findTestObject('Site/Form Site/FormSite_TextInputStatus'), Keys.chord(Keys.ENTER))
} else {
    WebUI.setText(findTestObject('Site/Form Site/FormSite_TextInputStatus'), 'Non Active')
