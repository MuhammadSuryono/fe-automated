...
WebUI.click(findTestObject('Site Page/Page_/i_Last Update2021-06-18 140816_fa fa-fw fa-trash-o'))
...
WebUI.click(findTestObject('Object Repository/Site Page/Page_/button_Yes'))

isSuccessIcon = WebUI.waitForElementVisible(findTestObject('Site/Dialog Success Create/DialogSuccessCreate_IconSuccess'), 30)

isSuccessText = WebUI.waitForElementVisible(findTestObject('Object Repository/Site Page/Page_/h2_Site deleted'), 30)
