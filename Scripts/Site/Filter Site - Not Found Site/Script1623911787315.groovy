...
WebUI.setText(findTestObject('Object Repository/Site Page/Page_/input_Site Name_filter-form form-control fo_4eac9a'), searchText)

WebUI.click(findTestObject('Object Repository/Site Page/Page_/button_Filter'))

getSiteSearch = WebUI.getText(findTestObject('Site Page/Page_/td_No records on database'))

assert getSiteSearch == 'No records on database'
