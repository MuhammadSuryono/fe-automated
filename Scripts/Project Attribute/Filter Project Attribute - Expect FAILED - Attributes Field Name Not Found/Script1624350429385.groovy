...
WebUI.setText(findTestObject('Object Repository/Page_/input_Attributes Field Name_filter-form for_422cc8'), 'anisa')

WebUI.click(findTestObject('Object Repository/Page_/button_Filter'))

noRecord = WebUI.getText(findTestObject('Object Repository/Page_/td_No records on database'))

assert noRecord == 'No records on database'
