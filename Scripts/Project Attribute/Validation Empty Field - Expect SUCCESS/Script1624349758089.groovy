...
WebUI.click(findTestObject('Object Repository/Page_/button_Add Project Attribute'))

WebUI.click(findTestObject('User/FormUser_ButtonSave'))

requiredName = WebUI.verifyElementVisible(findTestObject('Object Repository/Page_/small_Attribute Name is Required'))

requiredType = WebUI.verifyElementVisible(findTestObject('Object Repository/Page_/small_Attribute Types is Required'))

assert requiredName && requiredType
