...
WebUI.rightClick(findTestObject('Workflow/SidebarMenu_ProjectsManagement'))
...
WebUI.click(findTestObject('Object Repository/Page_/div_- Choose Project -'))

getProject = WebUI.getText(findTestObject('Object Repository/Page_/div_PRJ0010 - Dev Project Labeling'))

WebUI.click(findTestObject('Object Repository/Page_/div_PRJ0010 - Dev Project Labeling'))
